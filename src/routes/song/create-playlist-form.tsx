...
import { createPlaylistSchemaType, playlistSchema } from "@/lib/schemas/playlist"
import { zodResolver } from "@hookform/resolvers/zod"
import { useForm } from "react-hook-form"

export default function CreatePlaylistForm({ onCancel, onSave, songs }: { onCancel?: () => void; onSave?: () => void; songs?: string[] }) {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription className="sr-only">This is the name of the playlist.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
