            ...
            >
                <div className="flex gap-4 items-center">
                    ...
                    <div className=" gap-3 flex justify-between">
                        <span className="font-semibold min-w-[13rem] max-w-[13rem] text-ellipsis overflow-hidden whitespace-nowrap">
                            {song.title}
                        </span>
                ...
                <div className="flex gap-1 items-center">
                    ...
                    <div className="flex gap-4 border border-dashed rounded-lg px-2">
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center gap-4">
                <HoverCard openDelay={500} closeDelay={0}>
                    <HoverCardTrigger className="p-1">
                        <TextAlignCenterIcon />
                    </HoverCardTrigger>
                    <HoverCardContent
                        className="w-fit text-xs max-h-[20rem] overflow-hidden"
...
const AllSongs = () => {
    ...
    return (
        <>
            <div className="absolute right-3 -top-12 flex items-center gap-4">
                <Popover>
                    <PopoverTrigger>
                        <MixerHorizontalIcon />
                    </PopoverTrigger>
