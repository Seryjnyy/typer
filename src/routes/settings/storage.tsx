...
import { QueueStorage as QueueStorageType, usePreferenceStore } from "@/lib/store/preferences-store"
        ...
        <div className="space-y-2">
            ...
            <Card>
                        ...
                        {options.map((option) => (
                            <div className="border rounded-md p-2 flex justify-between" key={option.id}>
                                ...
                                <div className="flex justify-center items-center px-4 border-l ">
                                    <Checkbox
                                        checked={queueStoragePreference == option.value}
                                        onCheckedChange={() => {
                                            setQueueStoragePreference(option.value)
                                        }}
                                    />
                                </div>
                            </div>
                ...
                <CardFooter className="border-t pt-4">
                    <p className="text-xs text-muted-foreground">This will require a page refresh to take effect.</p>
                </CardFooter>
            </Card>
        </div>
    )
            ...
            <div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>The primary store used for all user data.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div>
                            <ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[250px]">
                                <PieChart>
                                    <ChartTooltip content={<ChartTooltipContent nameKey="bytes" hideLabel />} />
                                    <Pie data={chartData} dataKey="bytes" isAnimationActive={false}>
                                        <LabelList
                                            dataKey="state"
                    ...
                    <CardFooter className="border-t px-6 py-4">
                        <span className="text-xs text-muted-foreground">
                            Strings in JavaScript are UTF-16, so each character requires two bytes of memory. This means that while many
                            browsers have a 5 MB limit, you can only store 2.5 M characters.
                        </span>
                    </CardFooter>
                </Card>
            </div>
            ...
            <div className="space-y-2">
                ...
                <Card className="flex justify-between items-center border border-destructive">
                    <CardHeader>
                        ...
                        <CardDescription>This will remove ALL songs in localStorage.</CardDescription>
                    </CardHeader>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        This action cannot be undone. This will permanently delete your stored songs.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={onClearSongs}>Continue</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                    </CardFooter>
                ...
                <Card className="flex justify-between items-center border border-destructive">
                    <CardHeader>
                        ...
                        <CardDescription>This will remove ALL playlists in localStorage.</CardDescription>
                    </CardHeader>
                    <CardFooter className="p-0 pr-4">
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                                    <AlertDialogDescription>
                                        This action cannot be undone. This will permanently delete your stored playlists.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={handleClearPlaylists}>Continue</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                    </CardFooter>
                ...
                <Card className="flex justify-between items-center border border-destructive">
                    <CardHeader>
                        ...
                        <CardDescription>
                            This will remove ALL data in localStorage stored by this app. Including songs, queue and preferences.
                        </CardDescription>
                    </CardHeader>
                    <CardFooter className="p-0 pr-4">
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                                    <AlertDialogDescription>
                                        This action cannot be undone. This will permanently remove everything stored by this app in
                                        localStorage.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={onClearLocalStorage}>Continue</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                    </CardFooter>
