            ...
            <div className="w-full flex flex-col justify-center items-center gap-12 border p-2 rounded-sm">
                <div className="flex flex-col items-center justify-center">
                    <span className="text-lg">
                        Successfully exported your songs.
                    </span>
                    <span className="text-muted-foreground">
                        Exported ({exported}) songs.
                    </span>
                </div>
...
export default function ImportExport() {
    ...
    const handleChangeSongExportPreferences = (
        option: string,
        val: boolean
    ) => {
        console.log(option);
    ...
    const handleChangeSongImportPreferences = (
        option: string,
        val: boolean
    ) => {
        console.log(option);
        ...
        <div className="space-y-12">
                ...
                <div className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Select what values from song to export.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col gap-2 py-1">
                                    ...
                                    {Object.entries(songMandatoryExports).map(
                                        (x) => (
                                            <div
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {Object.entries(songExportPreferences).map(
                                        (x) => (
                                            <div
                                                className="flex gap-2"
                                                key={x[0]}
                                                ...
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={(val) => {
                                                        if (
                                                            ...
                                                            return;
                                                        handleChangeSongExportPreferences(
                                                            x[0],
                                                            val
                                                        );
                                                    }}
                        ...
                        <CardFooter className="border-t px-6 py-4">
                            <span className="text-xs text-muted-foreground">
                                Everything optional will be generated
                ...
                <div className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Select what values from song to import.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col gap-2 py-1">
                                    ...
                                    {Object.entries(songMandatoryImports).map(
                                        (x) => (
                                            <div
                                                className="flex gap-2"
                                                key={x[0]}
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {Object.entries(songImportPreferences).map(
                                        (x) => (
                                            <div
                                                className="flex gap-2"
                                                key={x[0]}
                                                ...
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={(val) => {
                                                        if (
                                                            ...
                                                            return;
                                                        handleChangeSongImportPreferences(
                                                            x[0],
                                                            val
                                                        );
                                                    }}
                        ...
                        <CardFooter className="border-t px-6 py-4">
                            <span className="text-xs text-muted-foreground">
                                Everything unselected will be generated
                                automatically on import.
                            </span>
                        </CardFooter>
                    </Card>
            ...
            <Card className="flex justify-between items-center border border-destructive">
                <CardHeader>
                    ...
                    <CardDescription>
                        This will reset all your import/export preferences to
                        the defaults.
                    </CardDescription>
                </CardHeader>
                <CardFooter className="p-0 pr-4">
                    <Button
                        variant={"destructive"}
                        onClick={handleResetImportExportPref}
                    >
                        Reset
                    </Button>
                </CardFooter>
